...
function checkMatchedBlocks(firstBlock, secondBlock) {
    let triesWrongg = document.querySelector(".tries-wrong span");
    let triesTruee = document.querySelector(".tries-true span");
    if (firstBlock.dataset.img === secondBlock.dataset.img) {
        triesTruee.innerHTML =parseInt(triesTruee.innerHTML) + 1;
        ...
        triesWrongg.innerHTML =parseInt(triesWrongg.innerHTML) + 1;
        setTimeout( () => {
            firstBlock.classList.remove('is-flipped');
            secondBlock.classList.remove('is-flipped');
        }, duration);
